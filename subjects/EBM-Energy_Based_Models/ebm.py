...
np.random.seed(42)
X, y = make_blobs(
    n_samples=100, centers=2, n_features=2, cluster_std=1.5, random_state=42
)
...
plt.scatter(
    X[y == 1, 0], X[y == 1, 1], label="True +1", edgecolors="k", marker="o"
)
plt.scatter(
    X[y == -1, 0], X[y == -1, 1], label="True -1", edgecolors="k", marker="x"
)
...
plt.scatter(
    X[y == 1, 0], X[y == 1, 1], edgecolors="k", facecolors="none", marker="o"
)
plt.scatter(
    X[y == -1, 0], X[y == -1, 1], edgecolors="k", facecolors="none", marker="x"
)
